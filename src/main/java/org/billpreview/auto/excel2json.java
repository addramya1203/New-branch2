...
public class excel2json {
	...
	private excel2json config = null;
	
	public excel2json(excel2json config) {
		this.config = config;
	}
	
	public static excel2json convert(excel2json config) throws InvalidFormatException, IOException {
		return new excel2json(config).convert();
	}
